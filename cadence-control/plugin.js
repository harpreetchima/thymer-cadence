...
const DAILY_RUNTIME_CSS = ".panel-menubar-buttons button[data-tooltip-html^=\"Open weekly note\"],\n.panel-menubar-buttons button[data-tooltip-html^=\"Open monthly note\"],\n.panel-menubar-buttons button[data-tooltip-html^=\"Open quarterly note\"],\n.panel-menubar-buttons button[data-tooltip-html^=\"Open yearly note\"] {\n  padding-left: 5px;\n  padding-right: 5px;\n  transition: background-color 0.3s, border-color 0.3s;\n}\n\n.cmdpal--inline.cadence-datepicker-popup {\n  width: auto !important;\n  max-width: calc(100vw - 40px) !important;\n}\n\n.cmdpal--inline .id--datepicker .datepicker-wrapper.cadence-datepicker-enhanced {\n  width: auto;\n  max-width: none;\n  padding: 10px 12px 10px;\n}\n\n.cmdpal--inline .id--datepicker .datepicker-wrapper.cadence-datepicker-enhanced .datepicker-header {\n  gap: 10px;\n  margin-bottom: 8px;\n  padding: 0;\n}\n\n.cmdpal--inline .id--datepicker .current-month.cadence-native-month-trigger {\n  display: inline-flex !important;\n  align-items: center;\n  justify-content: center;\n  width: 16px;\n  height: 16px;\n  flex: 0 0 16px;\n  margin-left: -2px;\n  overflow: hidden;\n  white-space: nowrap;\n  color: transparent;\n  font-size: 0;\n  border-radius: 999px;\n}\n\n.cmdpal--inline .id--datepicker .current-month.cadence-native-month-trigger::after {\n  content: '';\n  width: 4px;\n  height: 4px;\n  border-radius: 999px;\n  background: var(--text-muted);\n}\n\n.cmdpal--inline .id--datepicker .current-month.cadence-native-month-trigger:hover {\n  background: var(--button-bg-hover-color);\n}\n\n.cmdpal--inline .id--datepicker .cadence-datepicker-links {\n  display: flex;\n  align-items: center;\n  gap: 6px;\n  flex: 1 1 auto;\n  min-width: 0;\n}\n\n.cmdpal--inline .id--datepicker .cadence-datepicker-link,\n.cmdpal--inline .id--datepicker .cadence-datepicker-weeknum {\n  border: none;\n  background: transparent;\n  color: var(--panel-fg-color);\n  font: inherit;\n  padding: 0;\n  margin: 0;\n  cursor: pointer;\n}\n\n.cmdpal--inline .id--datepicker .cadence-datepicker-link {\n  font-weight: var(--font-weight-medium);\n  line-height: 1.15;\n}\n\n.cmdpal--inline .id--datepicker .cadence-datepicker-link:hover,\n.cmdpal--inline .id--datepicker .cadence-datepicker-weeknum:hover {\n  color: var(--text-hilite);\n}\n\n.cmdpal--inline .id--datepicker .cadence-datepicker-link.is-disabled,\n.cmdpal--inline .id--datepicker .cadence-datepicker-weeknum.is-disabled {\n  color: var(--text-muted);\n  cursor: default;\n  opacity: 0.75;\n}\n\n.cmdpal--inline .id--datepicker .cadence-native-nav {\n  display: flex !important;\n  gap: 4px !important;\n  align-items: center;\n}\n\n.cmdpal--inline .id--datepicker .cadence-native-nav .go-to-today {\n  width: auto;\n  min-width: 0;\n  padding: 0 6px;\n  color: transparent;\n  font-size: 0;\n}\n\n.cmdpal--inline .id--datepicker .cadence-native-nav .go-to-today::after {\n  content: 'Today';\n  font-size: var(--text-size-smaller);\n  color: var(--text-muted);\n  line-height: 1.15;\n}\n\n.cmdpal--inline.cadence-datepicker-popup .autocomplete.clickable {\n  overflow: visible;\n}\n\n.cmdpal--inline.cadence-datepicker-popup .vscroll-node,\n.cmdpal--inline.cadence-datepicker-popup .vcontent {\n  overflow: visible !important;\n  max-height: none !important;\n}\n\n.cmdpal--inline.cadence-datepicker-popup .vscrollbar.scrollbar {\n  display: none !important;\n}\n\n.cmdpal--inline .id--datepicker .datepicker-weekdays,\n.cmdpal--inline .id--datepicker .datepicker-days {\n  display: grid;\n  grid-template-columns: 20px repeat(7, 28px);\n  column-gap: 4px;\n  width: max-content;\n}\n\n.cmdpal--inline .id--datepicker .datepicker-weekdays {\n  margin-bottom: 2px;\n}\n\n.cmdpal--inline .id--datepicker .datepicker-days {\n  height: auto;\n  row-gap: 2px;\n}\n\n.cmdpal--inline .id--datepicker .datepicker-weekdays .weekday,\n.cmdpal--inline .id--datepicker .cadence-datepicker-weeklabel,\n.cmdpal--inline .id--datepicker .cadence-datepicker-weeknum {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  width: auto;\n  min-width: 0;\n}\n\n.cmdpal--inline .id--datepicker .datepicker-weekdays .weekday,\n.cmdpal--inline .id--datepicker .cadence-datepicker-weeklabel {\n  font-size: 9px;\n  letter-spacing: 0.08em;\n  text-transform: uppercase;\n  color: var(--text-muted);\n}\n\n.cmdpal--inline .id--datepicker .cadence-datepicker-weeknum {\n  font-size: var(--text-size-smaller);\n  color: var(--text-muted);\n  border-radius: var(--radius-normal);\n  height: 28px;\n  min-height: 28px;\n  line-height: 28px;\n  justify-self: stretch;\n  position: relative;\n  z-index: 1;\n  pointer-events: auto;\n}\n\n.cmdpal--inline .id--datepicker .datepicker-days .day {\n  width: 28px;\n  height: 28px;\n  line-height: 28px;\n  min-width: 0;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n\n.cmdpal--inline .id--datepicker .datepicker-days .day .day-inner {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  width: 24px;\n  height: 24px;\n  line-height: 24px;\n}\n";
